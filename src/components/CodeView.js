    ...
    render() {
        ...
        return(
            <div className="App">
                ...
                <NavBar items={["Code", "Gallery", "Videos", "About"]} selection="Code"/>
                ...
                <div className="arrow-container-left point-to-first">
                    <SVG className={arrowClassName}  src={Arrow} />
                </div>
                <div className={arrowTextClassName + " first-text"}>
                    Check<br/>the<br/>code
                </div>
